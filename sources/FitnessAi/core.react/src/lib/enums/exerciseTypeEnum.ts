...
export const exerciseTypeLabels: Record<ExerciseTypeEnum, string> = Object.fromEntries(
  Object.entries(ExerciseTypeEnum).map(([label, value]) => [value, label]),
) as Record<ExerciseTypeEnum, string>;
